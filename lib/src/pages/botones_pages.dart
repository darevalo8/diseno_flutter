  ...
  Widget _botonesRedondeados() {
    return Table(
      children: [
        ...
        TableRow(children: [
          _crearBotonRedondeado(Colors.pink, Icons.shop, 'Shop'),
          _crearBotonRedondeado(Colors.blueAccent, Icons.shopping_basket, 'Laura'),
        ]),
        TableRow(children: [
          _crearBotonRedondeado(Colors.redAccent, Icons.school, 'Grado'),
          _crearBotonRedondeado(Colors.blue, Icons.border_all, 'General'),
        ]),
        TableRow(children: [
          _crearBotonRedondeado(Colors.blue, Icons.border_all, 'General'),
